...
Directory Structure
ChurchBellsSystem/
├─ app.py                 # Bell scheduler web app (port 8080)
├─ home.py                # Default homepage (port 80)
├─ bells.db               # Auto-created SQLite database
├─ sounds/
│  └─ chime.wav           # Default chime generated by install.sh
├─ templates/
│  ├─ base.html
│  ├─ login.html
│  └─ alarms.html
